...
class ConexionMysql:
    ...
    def Insertar(self, tabla, valores)->bool:
        sql = f"INSERT INTO {tabla} (nombre,correo,contraseña,id) VALUES (%s, %s, %s, %s)"
...
if __name__ == '__main__':
    ...
    if conexion.BanConexion:
        ...
        if res != None:
            for fila in res:
                print(f"ID: {fila[0]}, Nombre usuario: {fila[1]},correo electronico: {fila[2]}, contraseña: {fila[3]}, id: {fila[4]}")
        else:
